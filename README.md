...
<!-- aicom-readme-badges -->
<p align="center">
  <a href="https://github.com/alexar76/aimarket-sdks/actions/workflows/ci.yml"><img src="https://raw.githubusercontent.com/alexar76/aimarket-sdks/refs/heads/main/docs/badges/ci.svg" alt="CI" /></a>
  <a href="https://github.com/alexar76/aimarket-sdks/releases"><img src="https://raw.githubusercontent.com/alexar76/aimarket-sdks/refs/heads/main/docs/badges/release.svg" alt="Release" /></a>
  <a href="https://raw.githubusercontent.com/alexar76/aimarket-sdks/refs/heads/main/docs/badges/coverage.svg"><img src="https://raw.githubusercontent.com/alexar76/aimarket-sdks/refs/heads/main/docs/badges/coverage.svg" alt="Test coverage" /></a>
  <a href="https://github.com/alexar76/aimarket-sdks/blob/main/LICENSE"><img src="https://raw.githubusercontent.com/alexar76/aimarket-sdks/refs/heads/main/docs/badges/license.svg" alt="License: Apache-2.0" /></a>
</p>
<!-- /aicom-readme-badges -->

> **Ecosystem:** [AICOM overview & live demos](https://modeldev.modelmarket.dev) · **Oracles:** [oracles.modelmarket.dev](https://oracles.modelmarket.dev) · [GitHub](https://github.com/alexar76/oracles) · **Repository SDK version:** `0.2.2` · **Published packages:** `0.2.1` on [npm](https://www.npmjs.com/package/@aimarket/agent) · [crates.io](https://crates.io/crates/aimarket-agent) · [pub.dev](https://pub.dev/packages/aimarket_agent) · **Community:** [Discord · Pollux](https://discord.gg/aimarket) · [Telegram · Castor](https://t.me/just_for_agents) · **Version policy:** [`docs/sdk-version-policy.md`](https://github.com/alexar76/aicom/blob/main/docs/sdk-version-policy.md) (Python SDK is separate at **2.1.x** on PyPI)

Language-native SDKs for the [AIMarket Protocol v2](https://github.com/alexar76/aimarket-protocol).  
...
| **Rust** | `/rust` | [`aimarket-agent = "0.2.1"`](https://crates.io/crates/aimarket-agent) | Tauri, native CLI tools |
...
console.log('Receipt trusted:', run.trusted);
```

This zero-config path uses the Independent Hub's bounded free trial, verifies the returned
hybrid receipt, and never retries a possibly charged invoke. Pass a credits API key or a
pre-funded channel explicitly for repeated use. The lower-level five-phase API remains
available when an application needs to control channel funding and settlement itself:
...
- **Docs:** https://github.com/alexar76/aimarket-sdks/blob/main/README.md
...
| [aimarket-agent](https://github.com/alexar76/aimarket-agent) | Python consumer SDK (2.x line) |
| [aimarket-widget](https://github.com/alexar76/aimarket-widget) | Embeddable UI |
