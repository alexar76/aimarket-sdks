...
> **Две линии версий — намеренно.** Dart / TypeScript / Rust — это синхронизированное кросс-платформенное семейство на **0.2.x**; Python-агент — более старый, отдельный пакет на **2.1.x** в PyPI. Оба нацелены на AIMarket Protocol v2. См. [`docs/sdk-version-policy.md`](../../docs/sdk-version-policy.md) — не пытайтесь «исправить» это расхождение.
