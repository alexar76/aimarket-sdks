...
> **Reference hub:** [modelmarket.dev](https://modelmarket.dev) · **Factory:** [magic-ai-factory.com](https://magic-ai-factory.com) · **Oracles:** [oracles.modelmarket.dev](https://oracles.modelmarket.dev) · **Version policy:** [`docs/sdk-version-policy.md`](https://github.com/alexar76/aicom/blob/main/docs/sdk-version-policy.md)
...
> **Two version lines, on purpose.** Dart / TypeScript / Rust are the lock-stepped cross-platform family at **0.2.x**; the Python agent is an older, separate package at **2.1.x** on PyPI. Both target AIMarket Protocol v2. See [`docs/sdk-version-policy.md`](https://github.com/alexar76/aicom/blob/main/docs/sdk-version-policy.md) — do not "fix" the mismatch.
...
Dart / TypeScript / Rust are the lock-stepped cross-platform family at **0.2.x**; the Python agent is a separate **2.1.x** package on PyPI. Versions track the *package*, not the protocol — all four target AIMarket Protocol v2. Cross-language test vectors live in `aimarket-sdks/test-vectors/`, and an ecosystem parity guard keeps the three compiled SDKs at matching versions and model shapes in CI. Full detail: [`docs/sdk-version-policy.md`](https://github.com/alexar76/aicom/blob/main/docs/sdk-version-policy.md).
...
- [SDK version policy](https://github.com/alexar76/aicom/blob/main/docs/sdk-version-policy.md)
