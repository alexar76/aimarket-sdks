...
class TeeVerifier {
  ...
  TeeVerificationResult verifyAttestationDetailed(
    ...
    final enclaveKey = _enclavePublicKeys[attestation.platform];
    if (enclaveKey == null) {
      failures.add(
...
const _defaultEnclavePublicKeys = <String, String>{
